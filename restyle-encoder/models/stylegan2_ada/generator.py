import torch
import numpy as np
from models.stylegan2_ada.utils import activation_funcs, FullyConnectedLayer, clamp_gain, modulated_conv2d, SmoothUpsample, normalize_2nd_moment, identity
...
class Generator(torch.nn.Module):
    ...
    def forward(self, z, truncation_psi=1, truncation_cutoff=None, noise_mode='random', input_is_latent=False, randomize_noise=None, return_latents=False):
        ...
        # print()
        if return_latents:
            return out_synth[0], z
        return out_synth[0], None
        # return out_synth[0]
    ...
    def get_latent(self, input):
        return self.mapping(input, 
                            truncation_psi=1, 
                            truncation_cutoff=None)    # hardcoded for compatibility
