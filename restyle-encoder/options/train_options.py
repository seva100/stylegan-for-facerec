...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--n_gpus', default=1, type=int,
                                 help='Number of gpus')
        ...
        self.parser.add_argument('--generator_ada', default=False, action='store_true',
                                 help='Specify when the StyleGAN2-ADA architecture is used')
