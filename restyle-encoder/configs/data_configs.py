...
DATASETS = {
	...
	'AfrAsianFaceSet': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['AfrAsianFaceSet'],
		'train_target_root': dataset_paths['AfrAsianFaceSet'],
		'test_source_root': dataset_paths['celeba_test_112p'],
		'test_target_root': dataset_paths['celeba_test_112p'],
	},
}