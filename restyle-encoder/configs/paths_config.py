dataset_paths = {
	...
	'AfrAsianFaceSet': '<path to prior dataset>',
	'celeba_test_112p': '<path to CelebA, aligned and cropped to 112x112, or some small part of it>',
...
model_paths = {
	...
	# 'ir_se50': None,
	'facerec_ir_se50': 'pretrained_models/model_ir_se50.pth',
	'ir_se101': None,
