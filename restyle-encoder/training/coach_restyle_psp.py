...
class Coach:
	def __init__(self, opts):
		...
		# 		self.net.module.latent_avg = self.net.module.decoder.mean_latent(int(1e5))[0].detach()
			
		# 	# get the image corresponding to the latent average
		# 	latent_avg = self.net.module.latent_avg.unsqueeze(0)

		# 	latent_avg = latent_avg.repeat(self.n_gpus, 1, 1)    # to make it divisible by n_gpus

		# 	print('latent_avg.shape', latent_avg.shape, 'latent_avg.device', latent_avg.device)
		# 	self.avg_image = self.net(latent_avg,
		# 							input_code=True,
		# 							randomize_noise=False,
		# 							return_latents=False,
		# 							average_code=True)[0]
	...
	def parse_and_log_images(self, id_logs, x, y, y_hat, title, subscript=None, display_count=2):
		...
		for i in range(display_count):
			...
			# print('cur_im_data:', cur_im_data)
			# print('cur_im_data[output_face]:', cur_im_data['output_face'])
